...
> **依存**: このスキルは `create-slide` スキルの参照ファイルを相対パスで参照する。
> - `../create-slide/references/content-limits.md` — コンテンツ量の判定上限
> - `../create-slide/references/mermaid-guide.md` — Mermaid 図の記法・埋め込み手順
...
1. **コンテンツ量**: 各スライドのコンテンツ量を [content-limits.md](../create-slide/references/content-limits.md) の判定上限と照合
...
レビュー時の判定上限は [content-limits.md](../create-slide/references/content-limits.md) の**判定上限**列を参照。
...
詳細は [../create-slide/references/mermaid-guide.md](../create-slide/references/mermaid-guide.md) の「記法の注意点」を参照。
...
判定基準: [content-limits.md](../create-slide/references/content-limits.md) の「折り返し孤立文字の防止」を参照。
